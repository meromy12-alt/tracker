...
const GOOGLE_BOOKS_KEY = "AIzaSyBwITmWfX-ocya_EQPdwi7c7TONZI4JQRE";
    ...
    const GENRES = [
        ...
        // 3. Fiction subgenres (refinement layer)
        "Urban Fantasy",
        "Dark Fantasy",
        "Cyberpunk",
        "Steampunk",
    ...
    const SUBJECT_TO_GENRE = {
        ...
        "paranormal": "Paranormal / Supernatural Fiction",
        "supernatural": "Paranormal / Supernatural Fiction",

        "police procedural": "Police Procedural",

        "true crime": "True Crime",

        "lgbtq": "Queer / LGBTQ+ Fiction",
        "queer": "Queer / LGBTQ+ Fiction",
        ...
        "self-help": "Self-help / Self-development",
        "self help": "Self-help / Self-development",
        "personal development": "Self-help / Self-development",
...
function detectGenres(subjects) {
    ...
    const MOOD_TO_QUERY = {
        modern: {
            cosy: 'cozy mystery OR feel-good fiction OR comfort read',
            funny: 'comedy fiction OR humorous novel OR funny book OR satire',
            dark: 'dark fiction OR psychological thriller OR gothic novel',
            tense: 'thriller OR psychological suspense OR crime fiction',
            mysterious: 'mystery novel OR detective fiction OR whodunit',
            emotional: 'emotional fiction OR tearjerker OR family drama',
            reflective: 'literary fiction OR philosophical novel OR memoir',
            hopeful: 'uplifting fiction OR inspirational novel OR feel-good',
            uplifting: 'uplifting novel OR feel-good fiction OR heartwarming',
            adventurous: 'adventure fiction OR action novel OR quest fantasy',
            romantic: 'romance novel OR love story OR romantic fiction',
            suspenseful: 'suspense thriller OR page-turner OR crime thriller',
            whimsical: 'whimsical fiction OR magical realism OR quirky novel',
            sad: 'emotional drama OR heartbreaking fiction OR literary novel',
            inspiring: 'inspiring memoir OR motivational nonfiction OR biography',
        },
        classic: {
            cosy: 'classic cozy mystery OR Agatha Christie OR village mystery',
            funny: 'classic comedy OR P.G. Wodehouse OR comic novel satire',
            dark: 'gothic fiction OR Edgar Allan Poe OR horror classic',
            tense: 'classic thriller OR suspense novel OR Alfred Hitchcock',
            mysterious: 'classic mystery OR Sherlock Holmes OR detective fiction',
            emotional: 'classic romance OR Jane Austen OR Victorian fiction',
            reflective: 'classic philosophy OR Dostoevsky OR literary classic',
            hopeful: 'classic coming of age OR bildungsroman OR Jane Austen',
            uplifting: 'classic feel-good OR Dickens OR heartwarming classic',
            adventurous: 'classic adventure OR Jules Verne OR Robert Louis Stevenson',
            romantic: 'classic romance OR Jane Austen OR Bronte romance',
            suspenseful: 'classic thriller OR spy novel OR Graham Greene',
            whimsical: 'classic whimsy OR Lewis Carroll OR fairy tale',
            sad: 'tragic classic OR Thomas Hardy OR heartbreaking novel',
            inspiring: 'classic biography OR inspiring memoir OR historical figure',
        },
    };
